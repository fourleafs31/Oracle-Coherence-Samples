...
echo "${JAVA_HOME}/bin/java -server -classpath ${CLASSPATH} ${JAVA_OPTION} -Xmx128m -Xms128m com.oracle.handson.RunEmployeeExample"

${JAVA_HOME}/bin/java -server -classpath ${CLASSPATH} ${JAVA_OPTION} -Xmx128m -Xms128m com.oracle.handson.RunEmployeeExample
pid=$!
echo "PID => $pid"
